          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              ...
              <button className="btn btn-primary">
                <Link to="/model/grammar-check" style={{ color: "black" }}>
                  Grammar Checker{" "}
                </Link>
              </button>
            </div>
            ...
            <div className="col-lg-6">
              ...
              <br />
              <button className="btn btn-primary">
                <Link to="/model/Chat-bot" style={{ color: "black" }}>
                  ConvoMate Chatbot{" "}
                </Link>
              </button>
            </div>
            ...
            <div className="col-lg-6">
              ...
              <br />
              <button className="btn btn-primary">
                <Link to="/model/translator" style={{ color: "black" }}>
                  Language translator
                </Link>
              </button>
            </div>
            ...
            <div className="col-lg-6">
              ...
              <br />
              <button className="btn btn-primary">
                <Link to="/model/Summariser" style={{ color: "black" }}>
                  Text Summarizer{" "}
                </Link>
              </button>
            </div>
